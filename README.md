...
| `phased/` | The phase loop: 7-phase development as the default Claude Code workflow for ipaas, advanced by the author's GitHub approval per phase and run by a small Python daemon. Step A (ipaas skills, finalize, Phase trailer) built; daemon not yet; see `phased/docs/plan.md`. |
